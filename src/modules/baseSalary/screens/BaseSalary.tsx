...
import {
    useBaseSalaryQueryParams, useGetBaseSalarys,
    useUpdateBaseSalary
...
export default function BaseSalary() {
  ...
  const [isSubmitLoading, updateBaseSalary]: any =
    useUpdateBaseSalary();
  ...
  return (
    <div>
      ...
      <WhiteBox>
        {RenderLoading(isLoading,<Form onFinish={onFinish} form={form}>
            ...
            rules={requireRules}
            >
                <InputNumberAnt style={{width : 180}} addonAfter={<span>Vùng 1</span>}/>
            </FormItem>
            <FormItem
            className="mb-0"
            ...
            rules={requireRules}
            >
                <InputNumberAnt style={{width : 180}} addonAfter={<span>Vùng 2</span>}/>
            </FormItem>
            <FormItem
            className="mb-0"
            ...
            rules={requireRules}
            >
                <InputNumberAnt style={{width : 180}} addonAfter={<span>Vùng 3</span>}/>
            </FormItem>
            <FormItem
            className="mb-0"
            ...
            rules={requireRules}
            >
                <InputNumberAnt style={{width : 180}} addonAfter={<span>Vùng 4</span>}/>
            </FormItem>
            </Flex>
            <Flex align={'center'} gap={10} className='mt-1'>
            <h6 style={{width : '15%'}} className="mt-2">Lương quản lý vùng: </h6>
            <FormItem
            className="mb-0"
            name={'baseSalaryASM'}
            rules={requireRules}
