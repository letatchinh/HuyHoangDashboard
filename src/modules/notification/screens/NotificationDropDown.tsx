  ...
  return (
    <>
      ...
      >
        <DropdownToggle
          onClick={() => {
            if (pathname === PATH_APP.myNotification.root) {
              return;
            }
            setMenu(!menu);
          }}
        ...
        <DropdownMenu
          style={{ zIndex: 999, width: 360 }}
          className="dropdown-menu-lg dropdown-menu-end p-0 z"
        >
          <div className="p-3">
          ...
          >
            {isLoading ? (
              ...
              keys(notifications)?.map((date, index) => (
                <React.Fragment key={date}>
                  ...
                  {notifications?.[date]?.map((notification: any) => (
                    <NotificationItem
          ...
          <div className="p-2 border-top d-grid z-3">
            ...
            >
              <i className="uil-arrow-circle-right me-1"></i> Xem tất cả
            </Link>
          </div>
        </DropdownMenu>
      </Dropdown>
