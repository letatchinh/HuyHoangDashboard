...
export type PoliciesType = {
  ...
  'READ_CONFIGREPORTSALARYAUTO'|
  'WRITE_CONFIGREPORTSALARYAUTO' |
  'UPDATE_CONFIGREPORTSALARYAUTO' |
  'DELETE_CONFIGREPORTSALARYAUTO' |
  'DOWNLOAD_CONFIGREPORTSALARYAUTO' |
  'ADMIN_CONFIGREPORTSALARYAUTO' 
  ]: [string, policyType];
};
