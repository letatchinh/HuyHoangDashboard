...
export type PoliciesType = {
  ...
  'READ_UPDATETHEPHARMACYFOREMPLOYEE'|
  'WRITE_UPDATETHEPHARMACYFOREMPLOYEE' |
  'UPDATE_UPDATETHEPHARMACYFOREMPLOYEE' |
  'DELETE_UPDATETHEPHARMACYFOREMPLOYEE' |
  'DOWNLOAD_UPDATETHEPHARMACYFOREMPLOYEE' |
  'ADMIN_UPDATETHEPHARMACYFOREMPLOYEE' 
  ]: [string, policyType];
};
