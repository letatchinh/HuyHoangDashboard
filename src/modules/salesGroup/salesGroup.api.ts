...
const apis = {
    ...
    getChildrenBuyGroup: (query?: any) => requester.post(`/api/v1/workspace/partner-children`, query),
    ...
    getListMember: (query?: any) => requester.get(`/api/v1/sale-group/employee-search`, query),
