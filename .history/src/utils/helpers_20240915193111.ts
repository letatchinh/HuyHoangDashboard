...
//
export const getValueOfMath = (valueTarget:number,valueDiscount : number,typeValue : 'PERCENT' | 'VALUE',maxDiscount ?: number) => NoZero(maxDiscount ?  Math.min((typeValue === 'PERCENT' ?  valueDiscount * valueTarget / 100 : valueDiscount),maxDiscount) : typeValue === 'PERCENT' ?  valueDiscount * valueTarget / 100 : valueDiscount);
export const getValueOfMathShip = (isFreeShip:boolean,valueTarget:number,valueDiscount : number,typeValue : 'PERCENT' | 'VALUE',maxDiscount ?: number) => NoZero(isFreeShip ? 9999999999 : getValueOfMath(valueTarget,valueDiscount,typeValue,maxDiscount));
